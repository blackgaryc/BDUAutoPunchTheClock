...
global $db_conn;
$user_all=$db_conn->select_all_from_table("ptc_user",' where ptc_status=0 ');
//print_r($user_all);
if ($user_all==false)
    return;
...
function ptc_cron($user_data){
    ...
    db_log_write_history_log($PTC_run_status,$sub_ret->errorInfoList[0]->message,$e_ret['return_code']==0?1:0);
}